...
//     "client_id=" + client_id + "&" +
//     "response_type=code&" +
//     "redirect_uri=" + encodeURIComponent(redirect_uri) + "&scope=activity%20heartrate%20location%20nutrition%20profile%20settings%20sleep%20social%20weight";


// const signIn = document.getElementById('sign-in');

// signIn.addEventListener('click', chrome.identity.launchWebAuthFlow({'url': auth_url, 'interactive': true},
